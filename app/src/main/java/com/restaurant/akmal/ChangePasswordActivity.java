...
import com.restaurant.akmal.data.Constants;
import com.restaurant.akmal.model.RegisterResponse;
import com.restaurant.akmal.session.Session;
import com.restaurant.akmal.utils.DialogUtils;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void updateUser() {
        ...
        AndroidNetworking.post(Constants.UPDATE_PROFILE_USER + "/" + "akmal").addBodyParameter("nama", name.getText().toString()).addBodyParameter("old_password", oldPass.getText().toString()).addBodyParameter("new_password", newPass.getText().toString()).build().getAsObject(RegisterResponse.class, new ParsedRequestListener() {
            @Override
